...
const BrainConnection = () => {
  const styles = `
        ...
        @keyframes centralGlow {
            0%, 100% {
                filter: drop-shadow(0 0 15px rgba(157, 255, 161, 0.5));
            }
            50% {
                filter: drop-shadow(0 0 25px rgba(157, 255, 161, 1));
            }
        }
  ...
  return (
    <>
      ...
      <svg width="722" height="255" viewBox="0 0 722 255" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          <circle r="4" fill="url(#paint4_linear_515_68605)" filter="drop-shadow(0 0 6px rgba(157, 255, 161, 0.8))">
        ...
        <g>
          <circle r="4" fill="url(#paint7_linear_515_68605)" filter="drop-shadow(0 0 6px rgba(157, 255, 161, 0.8))">
            <animateMotion dur="3s" repeatCount="indefinite">
        ...
        <g>
          <circle r="4" fill="url(#paint13_linear_515_68605)" filter="drop-shadow(0 0 6px rgba(157, 255, 161, 0.8))">
            <animateMotion dur="3s" repeatCount="indefinite">
        ...
        <g>
          <circle r="4" fill="url(#paint16_linear_515_68605)" filter="drop-shadow(0 0 6px rgba(157, 255, 161, 0.8))">
            <animateMotion dur="3s" repeatCount="indefinite">
