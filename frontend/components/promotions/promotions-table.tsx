...
import { togglePromotionActive, deletePromotion } from "@/actionts/promotions/promotion-actions";
...
export function PromotionsTable({ promotions, onEdit }: PromotionsTableProps) {
